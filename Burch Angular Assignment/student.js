angular.module('studentApp', [])
  .controller('StudentController', function($scope) {
	...
	$scope.addThisStudent = function() {
		$scope.students.push({firstName:$scope.firstName, lastName:$scope.lastName, address:$scope.address, 
			city:$scope.city, state:$scope.state, country:$scope.country});
			
		//firstName = '';
	};	

	$scope.delete = function (students, index){
